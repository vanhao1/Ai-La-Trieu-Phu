...
import tdc.edu.vn.ailatrieuphu_n7_project.dialogs.CallDialog;
import tdc.edu.vn.ailatrieuphu_n7_project.dialogs.DiemSoDialog;
import tdc.edu.vn.ailatrieuphu_n7_project.dialogs.KhanGiaDialog;
import tdc.edu.vn.ailatrieuphu_n7_project.dialogs.ThongBaoDialog;
import tdc.edu.vn.ailatrieuphu_n7_project.layout.TienThuongLayout;
import tdc.edu.vn.ailatrieuphu_n7_project.manager.DatabaseManager;
import tdc.edu.vn.ailatrieuphu_n7_project.manager.NhacManager;
import tdc.edu.vn.ailatrieuphu_n7_project.model.CauHoi;

public class PlayerActivity extends Activity implements View.OnClickListener{
    private DatabaseManager databaseManager;
    private DrawerLayout drawerLayout;
    private TienThuongLayout layoutMoney;
    private LinearLayout layoutPlay;
    private ThongBaoDialog noticeDialog;
    private DiemSoDialog scoreDialog;
    private KhanGiaDialog audienceDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noticeDialog = new ThongBaoDialog(this);
        scoreDialog = new DiemSoDialog(this);
        audienceDialog = new KhanGiaDialog(this);
    ...
    private void findViewByIds() {
        ...
        layoutMoney = (TienThuongLayout) findViewById(R.id.layout_money);
    ...
    private void loadRules() {
        ...
        App.getMusicPlayer().play(NhacManager.LUAT_CHOI, new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mp) {
                ...
                if (mp == null) {
                    ...
                    App.getMusicPlayer().play(NhacManager.READY, null);
                    noticeDialog.show();
                }
            }
    ...
    private void startGame() {
        ...
        App.getMusicPlayer().play(R.raw.gofind, new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                drawerLayout.openDrawer(GravityCompat.START);
                App.getMusicPlayer().play(NhacManager.QUEST_1, new MediaPlayer.OnCompletionListener() {
                    @Override
                    public void onCompletion(MediaPlayer mp) {
                        App.getMusicPlayer().stop();
                        if (mp == null) {
    ...
    private void setQuestion() {
        CauHoi ques = questions.get(level - 1);
                ...
                if (mp == null) {
                    ...
                    if (getTrueAnswer() == id) {
                        if (level == 5 || level == 10 || level == 15) {
                            App.getMusicPlayer().play(NhacManager.ANS_NOW, new MediaPlayer.OnCompletionListener() {
                                @Override
                                public void onCompletion(MediaPlayer mp) {
                                    App.getMusicPlayer().stop();
                                    answerTrue(v, trueAns);
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                if (mp == null) {
                    ...
                    if (level == 5) {
                        ...
                        App.getMusicPlayer().play(NhacManager.VUOT_MOC_1,null);
                    } else if (level == 10) {
                        drawerLayout.openDrawer(GravityCompat.START);
                        drawerLayout.addDrawerListener(drawerListener);
    ...
    public void onClick(final View v) {
        switch (v.getId()) {
            case R.id.tv_case_a:
                checkAnswer(v, NhacManager.ANS_A, NhacManager.TRUE_A, 1);
                break;
            case R.id.tv_case_b:
                checkAnswer(v, NhacManager.ANS_B, NhacManager.TRUE_B, 2);
                break;
            case R.id.tv_case_c:
                checkAnswer(v, NhacManager.ANS_C, NhacManager.TRUE_C, 3);
                break;
            case R.id.tv_case_d:
                checkAnswer(v, NhacManager.ANS_D, NhacManager.TRUE_D, 4);
                break;
            ...
            case R.id.btn_5050:
                ...
                App.getMusicPlayer().play(NhacManager.SOUND_5050, new MediaPlayer.OnCompletionListener() {
                    @Override
                    public void onCompletion(MediaPlayer mp) {
                        App.getMusicPlayer().stop();
                        App.getMusicPlayer().resumeBgMusic();
    ...
    public void saveScore(boolean stopGame) {
        ...
        if (level > 1) {
            ...
            scoreDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                @Override
                public void onDismiss(DialogInterface dialog) {
                    App.getMusicPlayer().play(NhacManager.LOSE, new MediaPlayer.OnCompletionListener() {
                        @Override
                        public void onCompletion(MediaPlayer mp) {
                            App.getMusicPlayer().stop();
                            finish();
